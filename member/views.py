...
def mypage(request):
    ...
    # paginator2=Paginator( post_like_list, 6)
    ...
    return render(request, 'FE_tamplates/mypage.html', {'data':data,'incorrect_list':incorrect_list,'post_list':post_list,'post_correct_list': post_correct_list,'post_like_list':post_like_list})
...
def submitCodeCorrect(request):
    ...
    return render(request, 'FE_tamplates/correctCode.html', {'data':data, 'post_list': post_list})
...
def submitCodeIncorrect(request):
    ...
    return render(request, 'FE_tamplates/incorrectCode.html', {'data':data, 'incorrect_list': incorrect_list})
